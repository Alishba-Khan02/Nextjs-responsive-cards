...
export default function Cards(){
    return(
        ...
        <section className="container mx-auto p-10 md:py-12 px-0 md:p-8 md:px-0 card1">
        <section
            ...
            <Image 
                ...
                height={300} 
            />
                <h1  className="text-3xl my-5">Nike Shoe</h1>
            ...
            />
                ...
                <h1  className="text-3xl my-5">Sneakers Skate Shoe</h1>
                <p  className="mb-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio, incidunt....</p>
            ...
            />
                ...
                <h1  className="text-3xl my-5">Sneakers Basketball Shoe</h1>
                <p  className="mb-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio, incidunt...</p>
