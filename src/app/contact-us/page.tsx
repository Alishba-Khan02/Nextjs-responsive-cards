    ...
    <div className="relative py-3 sm:max-w-xl sm:mx-auto">
        ...
        <div className="text-white relative px-4 py-10 bg-indigo-400 shadow-lg sm:rounded-3xl sm:p-20">
            ...
            <form>
                ...
                <textarea
                        className=" shad shadow mb-4 min-h-0 appearance-none border rounded h-64 w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
